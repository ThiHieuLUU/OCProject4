...
<html>
   <head>
      <title>flake8 violations: venv/lib/python3.8/site-packages/pylint/message/__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.8.site-packages.pylint.message.__init__.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.8.site-packages.pylint.message.__init__.source.html#l39">
                  <tt><i>39</i> <span class="c1"># Licensed under the GPL: https://www.gnu.org/licenses/old-licenses/gpl-2.0.html</span></tt>
               </a>
            </li>
            </ul>
         </li>
